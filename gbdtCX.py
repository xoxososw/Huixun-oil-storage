                                ...
                                for learning_rate in list(range(1, 50, 1)):
                                    ...
                                    if acc_test > best_score:  # 找到表现最好的参数
                                        ...
                                        if bst_acc_tst < acc_test:
                                            ...
                                            # 保存训练的数据模型
                                            fw = open('GBDT-output/'+str_col+'/GBDT_model.txt', 'wb')
                                            pickle.dump(Gbdt, fw)
                                            fw.close()
                                            ...
                                            test_y.to_csv('GBDT-output/'+str_col+'/测试集预测结果.csv', index=False,encoding='utf_8_sig')
                                            ...
                                            with open('GBDT-output/'+str_col+'/评分结果.txt', 'w') as f:
                                                f.write(score)
                                            ...
                                            plt.savefig('GBDT-output/' + str_col + '/GBDT-混淆矩阵.png')
                                            plt.close()
