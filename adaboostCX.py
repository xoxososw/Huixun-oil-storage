...
# def main(X,y,str_col):
    ...
    for iter in range(1):
        ...
        best_score = 0
        cnt = 0
        for max_depth in list(range(1,20,2)):
                            ...
                            # for max_features in list(range(2,50,2)):
                                for learning_rate in list(range(1,20,1)):
                                    ...
                                    if bst_acc_tst < acc_test:
                                        ...
                                        # 保存训练的数据模型
                                        fw = open('./modelsCX/'+str_col+'/'+'ADA-output/ADA_model.pkl', 'wb')
                                        pickle.dump(ada, fw)
                                        fw.close()
                                        ...
                                        test_y.to_csv('./modelsCX/'+str_col+'/'+'ADA-output/predict-result.csv', index=False,encoding='utf_8_sig')
                                        ...
                                        with open('./modelsCX/'+str_col+'/'+'ADA-output/ADA-score.txt', 'w') as f:
                                            f.write(score)
                                        ...
                                        plt.savefig('./modelsCX/'+str_col+'/'+'ADA-output/ADA-Confusion Matrix.png')
                                        plt.close()
