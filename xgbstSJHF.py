                ...
                #         for min_samples_split in list(range(2,100,10)):
                            # for max_features in list(range(2,50,2)):
                                for learning_rate in list(range(1, 20, 1)):
                                    ...
                                    cnt += 1
                                    if cnt % 100 == 0:
                                        # print(max_depth, booster, learning_rate)
                                        print(max_depth, learning_rate)
                                    # print("第 %d 次" % (iter))
                                    ...
                                    if bst_acc_tst < acc_test:
                                        ...
                                        # 保存训练的数据模型
                                        fw = open('./models/' + str_col + '/' + 'XGB-output/XGB_model.pkl', 'wb')
                                        ...
                                        test_y.to_csv('./models/' + str_col + '/' + 'XGB-output/predict-result.csv', index=False,encoding='utf_8_sig')
                                        ...
                                        with open('./models/'+str_col+'/'+'XGB-output/XGB-score.txt', 'w') as f:
                                            f.write(score)
                                        ...
                                        plt.savefig('./models/'+str_col+'/'+'XGB-output/XGB-Confusion Matrix.png')
                                        plt.close()
